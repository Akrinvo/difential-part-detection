...
def draw_forward_arrow(canvas):
    ...
    # Define arrow points
    arrow_points = [(5, 10), (25, 10), (25, 5), (35, 12),
                    (25, 20), (25, 15), (5, 15)]
...
def cam_plate_detection_ui(image_path, cam_plate_frame, raw_frame):
    ...
    try:
        ...
        filename = f"/home/aspagteq/Documents/after_assembly/vision_station/muvro/result/cam_plate.jpg"
        ...
        no_cam_plate.config(
            text=f'No. of not detected cam plate: {cam_plate_no}')
...
def moving_plate_detection_ui(frame, moving_plate_frame, raw_frame):
    ...
    try:
        ...
        filename = f"/home/aspagteq/Documents/after_assembly/vision_station/muvro/result/moving_plate.jpg"
        cv2.imwrite(filename, img)
        ...
        y_moving_plate.config(
            text=f'No. of detected Pin Returning Plate: {moving_plate_yes}')
        no_moving_plate.config(
            text=f'No. of not detected Pin Returning Plate: {moving_plate_no}')
    except Exception as e:
        print(e)
        print("no img")
...
def isolated_washer_detection_ui(image_path, isolated_washer_frame, raw_frame):
    ...
    try:
        ...
        filename = f"/home/aspagteq/Documents/after_assembly/vision_station/muvro/result/isolated_plate.jpg"
        cv2.imwrite(filename, img)
        ...
        y_isolated_plate.config(
            text=f'No. of detected isolated Plate: {isolated_yes}')
        no_isolated_plate.config(
            text=f'No. of not detected isolated Plate: {isolated_no}')
    except Exception as e:
        print(e)
        print("no img")
...
def spherical_washer_detection_ui(image, spherical_washer_frame, raw_frame):
    ...
    try:
        ...
        filename = f"/home/aspagteq/Documents/after_assembly/vision_station/muvro/result/spherical_washer.jpg"
        cv2.imwrite(filename, img)
        ...
        y_spherical_washer.config(
            text=f'No. of detected spherical washer: {spherical_yes}')
        no_spherical_washer.config(
            text=f'No. of not detected spherical washer: {spherical_no}')
        no_b.config(text=f"Counter : {counter}")
    except Exception as e:
        print(e)
        print("no img")
...
def bolts_detection_ui(image_path, bolt_frame, raw_frame):
    ...
    try:
        ...
        filename = f"/home/aspagteq/Documents/after_assembly/vision_station/muvro/result/bolts.jpg"
        cv2.imwrite(filename, img)
...
def pin_detection_ui(image_path, pin_frame, raw_frame):
    ...
    try:
        ...
        filename = f"/home/aspagteq/Documents/after_assembly/vision_station/muvro/result/dpin.jpg"
        cv2.imwrite(filename, img)
            ...
            for loop in range(3):
                ...
                try:
                    ...
                    if topCamera is None:
                        ...
                        icon_img = cv2.imread("/home/aspagteq/Documents/after_assembly/vision_station/muvro/images/logo.jpg")
...
image_tk = load_image("/home/aspagteq/Documents/after_assembly/vision_station/muvro/images/logo.jpeg", 100, 50)
...
main_frame1 = LabelFrame(root, text="", font=(
    "times of roman", 5, "bold"), fg="black", relief=GROOVE, bg=bg_color, padx=5, pady=1)
...
raw_cam_plate_frame = LabelFrame(main_frame1, text="Raw Cam Plate", font=(
    "times new roman", 15, "bold"), padx=10, pady=10)
raw_cam_plate_frame.grid(row=1, column=0, padx=5, pady=5)

# raw cam plate image frontend
image_tk1 = load_image("/home/aspagteq/Documents/after_assembly/vision_station/muvro/images/cam_plate.jpg", 150, 150)
...
raw_moving_plate_frame = LabelFrame(main_frame1, text="Raw Pin Returning Plate", font=(
    "times new roman", 15, "bold"), padx=10, pady=10)
...
raw_isolated_washer_frame = LabelFrame(main_frame1, font=(
    "times new roman", 15, "bold"), text="Raw Isolated Plate", padx=10, pady=10)
raw_isolated_washer_frame.grid(row=1, column=2, padx=5, pady=5)

# raw isolated washer image frontend
image_tk6 = load_image("/home/aspagteq/Documents/after_assembly/vision_station/muvro/images/spherical_washer.jpg", 150, 150)
...
raw_spherical_washer_frame = LabelFrame(main_frame1, font=(
    "times new roman", 15, "bold"), text="Raw Flat Washer", padx=10, pady=10)
...
raw_bolts_frame = LabelFrame(main_frame1, font=(
    "times new roman", 15, "bold"), text="Raw Bolts", padx=10, pady=10)
raw_bolts_frame.grid(row=1, column=4, padx=5, pady=5, sticky="WENS")

# raw bolts image frontend
image_tk7 = load_image("/home/aspagteq/Documents/after_assembly/vision_station/muvro/images/bolts.jpeg", 150, 150)
...
raw_D_shape_frame = LabelFrame(main_frame1, text="Pin", font=(
    "times new roman", 15, "bold"), padx=10, pady=10)
raw_D_shape_frame.grid(row=1, column=5, padx=5, pady=5, sticky="WENS")

# raw D shape orientation image frontend
image_tk8 = load_image("/home/aspagteq/Documents/after_assembly/vision_station/muvro/images/spring.jpg", 150, 150)
...
cam_plate_frame = LabelFrame(main_frame, text="Cam Plate", font=(
    "times new roman", 15, "bold"), padx=10, pady=10)
cam_plate_frame.grid(row=0, column=0, padx=5, pady=5)

# moving plate image frontend
image_tk1 = load_image("/home/aspagteq/Documents/after_assembly/vision_station/muvro/images/cam_plate.jpg", 130, 130)
...
moving_plate_frame = LabelFrame(main_frame, text="Pin Returning Plate", font=(
    "times new roman", 15, "bold"), padx=10, pady=10)
...
isolated_washer_frame = LabelFrame(main_frame, font=(
    "times new roman", 15, "bold"), text="Isolated Plate", padx=10, pady=10)
isolated_washer_frame.grid(row=0, column=4, padx=5, pady=5)

# spherical washer image frontend
image_tk6 = load_image("/home/aspagteq/Documents/after_assembly/vision_station/muvro/images/spherical_washer.jpg", 130, 130)
...
# spherical washer label frame
spherical_washer_frame = LabelFrame(main_frame, font=(
    "times new roman", 15, "bold"), text="Flat Washer", padx=10, pady=10)
...
# bolts label frame
bolts_frame = LabelFrame(main_frame, font=(
    "times new roman", 15, "bold"), text="Bolts", padx=10, pady=10)
bolts_frame.grid(row=0, column=8, padx=5, pady=5)

# bolts image frontend
image_tk7 = load_image("/home/aspagteq/Documents/after_assembly/vision_station/muvro/images/bolts.jpeg", 130, 130)
...
D_shape_frame = LabelFrame(main_frame, text="Pin", font=(
    "times new roman", 15, "bold"), padx=10, pady=10)
D_shape_frame.grid(row=0, column=10, padx=5, pady=5)

# D shape orientation image frontend
image_tk8 = load_image("/home/aspagteq/Documents/after_assembly/vision_station/muvro/images/bolts.jpeg", 130, 130)
...
work = Label(details, text="", font=(
    "times new roman", 15, "bold"), bg=bg_color)
