...
bolt=[[328, 109, 26, 27], [359, 115, 25, 31], [386, 129, 25, 34], [408, 155, 22, 29], [419, 182, 23, 30], [423, 215, 21, 26], [412, 244, 23, 29], [393, 270, 28, 26], [367, 292, 33, 23], [341, 299, 30, 29], [309, 300, 29, 30], [280, 292, 30, 31], [255, 279, 27, 29], [237, 257, 24, 30], [226, 229, 27, 31], [225, 196, 22, 34], [232, 168, 26, 29], [247, 144, 21, 23], [267, 121, 31, 26], [293, 113, 36, 22]]
    ...
    if pause==0:
        for r,j in zip(bolt,range(1,21)):
            ...
            if len(param)<40:
                ...
                if param[f"min{j}"]>n_black:param[f"min{j}"]=n_black
                if param[f"max{j}"]<n_black:param[f"max{j}"]=n_black
