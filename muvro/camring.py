...
# good=image_loc("sona_data/left_focus/wcampring")
...
camringthrust=[mi,mx]
spr=json.dumps(r)
with open("camring.json", "w") as dic:
    dic.write(spr)

camringthrust=json.dumps(camringthrust)
with open("camringthrust.json", "w") as dic:
    dic.write(camringthrust)